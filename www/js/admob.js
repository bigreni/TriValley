  ...
  if( /(android)/i.test(navigator.userAgent) ) { // for android & amazon-fireos
    admobid = {
      ...
      interstitial: 'ca-app-pub-9249695405712287/1596574352'
    };
  } else if(/(ipod|iphone|ipad)/i.test(navigator.userAgent)) { // for ios
    admobid = {
      banner: 'ca-app-pub-1683858134373419/7790106682', // or DFP format "/6253334/dfp_example_ad"
      interstitial: 'ca-app-pub-9249695405712287/6026773955'
    };
  }
...
TransitMaster.StopTimes = function (options) {
    ...
    function getRoutes() {
        ...
        $.ajax({
            type: "POST",
            url: "http://webwatch.lavta.org/tmwebwatch/Arrivals.aspx/getRoutes",
    ...
    function getDirections() {
        ...
        $.ajax({
            type: "POST",
            url: "http://webwatch.lavta.org/tmwebwatch/Arrivals.aspx/getDirections",
    ...
    function getStops() {
        ...
        $.ajax({
            type: "POST",
            url: "http://webwatch.lavta.org/tmwebwatch/Arrivals.aspx/getStops",
    ...
    function getArrivalTimes(refresh) {
        ...
        $.ajax({
            type: "POST",
            url: "http://webwatch.lavta.org/tmwebwatch/Arrivals.aspx/getStopTimes",
